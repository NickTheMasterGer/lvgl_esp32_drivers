 ...
 *  STATIC PROTOTYPES
 **********************/
static uint8_t send_data(lv_fs_drv_t *disp_drv, void *bytes, size_t bytes_len);
static uint8_t send_pixels(lv_fs_drv_t *disp_drv, void *color_buffer, size_t buffer_len);
...
void ssd1306_set_px_cb(lv_fs_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w, lv_coord_t x, lv_coord_t y,
...
void ssd1306_flush(lv_fs_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
    /* Divide by 8 */
...
void ssd1306_rounder(lv_fs_drv_t * disp_drv, lv_area_t *area)
{
